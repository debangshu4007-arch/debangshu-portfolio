                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
                        ...
                        <div className="lg:col-span-6">
                            ...
                            <BlurFadeIn delay={0} blur={10} yOffset={15}>
                                <span className="font-body text-sm md:text-base uppercase tracking-[0.3em] text-stone block mb-6">
                                    Creative Portfolio
                                </span>
                            </BlurFadeIn>
                            ...
                            <BlurFadeIn delay={0.1} blur={12} yOffset={20}>
                                <h1 className="text-display-xl text-editorial text-charcoal">
                                    Crafting digital
                                    <br />
                        ...
                        <div className="lg:col-span-5 lg:col-start-8">
                            <BlurFadeIn delay={0.2} blur={15} yOffset={30} duration={0.9}>
